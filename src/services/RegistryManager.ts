...
import {
  ApmAdapter,
} from '../adapters/ApmAdapter';
import {
  AwesomeCopilotAdapter,
} from '../adapters/AwesomeCopilotAdapter';
import {
  GitHubAdapter,
} from '../adapters/GitHubAdapter';
import {
  GitLabAdapter,
} from '../adapters/GitLabAdapter';
import {
  HttpAdapter,
...
import {
  LocalApmAdapter,
} from '../adapters/LocalApmAdapter';
import {
  LocalAwesomeCopilotAdapter,
} from '../adapters/LocalAwesomeCopilotAdapter';
import {
  LocalOlafAdapter,
} from '../adapters/LocalOlafAdapter';
import {
  LocalSkillsAdapter,
} from '../adapters/LocalSkillsAdapter';
import {
  OlafAdapter,
} from '../adapters/OlafAdapter';
import {
  IRepositoryAdapter,
...
} from '../utils/bundleIdentityMatcher';
import {
...
import {
  BundleInstaller,
} from './BundleInstaller';
import {
  HubManager,
} from './HubManager';
import {
  LocalModificationWarningService,
} from './LocalModificationWarningService';
import {
  LockfileManager,
} from './LockfileManager';
import {
  VersionConsolidator,
} from './VersionConsolidator';
