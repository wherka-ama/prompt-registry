...
// NOSONAR typescript:S7741 — typeof is required here: CLI_VERSION is a declare const injected by the bundler and may not exist in dev builds; a direct comparison would throw ReferenceError.
