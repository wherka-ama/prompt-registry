 ...
 * - With branch/tree: https://github.com/owner/repo/tree/branch
 * - With query params: https://github.com/owner/repo?ref=branch
 * - Short format: owner/repo
 * - Trailing slashes and fragments are handled
 */
export function parseGitHubUrl(url: string): { owner: string; repo: string } {
    ...
    // Handle HTTPS URLs: https://github.com/owner/repo[.git][/tree/branch][/blob/branch]
    ...
    // Handle short format: owner/repo[.git]
