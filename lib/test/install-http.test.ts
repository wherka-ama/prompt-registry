...
import {
  ...
  envTokenProvider as defaultTokenProvider,
  ghCliTokenProvider,
  NULL_TOKEN_PROVIDER,
...
describe('HttpClient + TokenProvider', () => {
  ...
  describe('envTokenProvider', () => {
    it('returns the token for github.com hosts', async () => {
      const tp = defaultTokenProvider({ GITHUB_TOKEN: 'tk' });
